...
%    fprintf("Getting for: %s\n",  fullfile(data_path, 'train', categories{i}, '*.jpg'));
   images = dir( fullfile(data_path, 'train', categories{i}, '*.jpg'));
   for j=1:num_train_per_cat
       % fprintf("i: %d; j: %d; File: %s\n", i, j, fullfile(data_path, 'train', categories{i}, images(j).name));
...
%    fprintf("Getting for: %s\n",  fullfile(data_path, 'test', categories{i}, '*.jpg'));
